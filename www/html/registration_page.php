                        ...
                        <div class="card-body p-5 text-center">
                            <div class="mb-md-1 mt-md-1 pb-1">
                                ...
                                <form action="registration.php" method="post">
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        <input type="text" name="lastname" id="typeLastNameX" class="form-control form-control-lg" required placeholder="Last Name" />
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <input type="email" name="email" id="typeEmailX" class="form-control form-control-lg" required placeholder="Email" />
                                    </div>
